...
return array(
    'App\\Controller\\BadLocationController' => $baseDir . '/src/Controller/BadLocationController.php',
    'App\\Controller\\GoodLocationController' => $baseDir . '/src/Controller/GoodLocationController.php',
    ...
    'App\\Controller\\WeatherController' => $baseDir . '/src/Controller/WeatherController.php',
    'App\\Kernel' => $baseDir . '/src/Kernel.php',
    'App\\Service\\WeatherService' => $baseDir . '/src/Service/WeatherService.php',
    ...
    'Csa\\Bundle\\GuzzleBundle\\DependencyInjection\\CompilerPass\\MiddlewarePass' => $vendorDir . '/csa/guzzle-bundle/src/DependencyInjection/CompilerPass/MiddlewarePass.php',
    ...
    'Csa\\GuzzleHttp\\Middleware\\Cache\\Adapter\\DoctrineAdapter' => $vendorDir . '/csa/guzzle-cache-middleware/src/Adapter/DoctrineAdapter.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\Adapter\\MockStorageAdapter' => $vendorDir . '/csa/guzzle-cache-middleware/src/Adapter/MockStorageAdapter.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\Adapter\\PsrAdapter' => $vendorDir . '/csa/guzzle-cache-middleware/src/Adapter/PsrAdapter.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\Adapter\\StorageAdapterInterface' => $vendorDir . '/csa/guzzle-cache-middleware/src/Adapter/StorageAdapterInterface.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\CacheMiddleware' => $vendorDir . '/csa/guzzle-cache-middleware/src/CacheMiddleware.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\MockMiddleware' => $vendorDir . '/csa/guzzle-cache-middleware/src/MockMiddleware.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\NamingStrategy\\AbstractNamingStrategy' => $vendorDir . '/csa/guzzle-cache-middleware/src/NamingStrategy/AbstractNamingStrategy.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\NamingStrategy\\HashNamingStrategy' => $vendorDir . '/csa/guzzle-cache-middleware/src/NamingStrategy/HashNamingStrategy.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\NamingStrategy\\LegacyNamingStrategy' => $vendorDir . '/csa/guzzle-cache-middleware/src/NamingStrategy/LegacyNamingStrategy.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\NamingStrategy\\NamingStrategyInterface' => $vendorDir . '/csa/guzzle-cache-middleware/src/NamingStrategy/NamingStrategyInterface.php',
    'Csa\\GuzzleHttp\\Middleware\\Cache\\NamingStrategy\\SubfolderNamingStrategy' => $vendorDir . '/csa/guzzle-cache-middleware/src/NamingStrategy/SubfolderNamingStrategy.php',
    'Csa\\GuzzleHttp\\Middleware\\History\\History' => $vendorDir . '/csa/guzzle-history-middleware/src/History.php',
    'Csa\\GuzzleHttp\\Middleware\\History\\HistoryMiddleware' => $vendorDir . '/csa/guzzle-history-middleware/src/HistoryMiddleware.php',
    'Csa\\GuzzleHttp\\Middleware\\Stopwatch\\StopwatchMiddleware' => $vendorDir . '/csa/guzzle-stopwatch-middleware/src/StopwatchMiddleware.php',
